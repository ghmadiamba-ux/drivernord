...
// POST /api/agent/market-scan-weekly
//
// Cron-facing endpoint for the weekly deep Market Agent scan.
// Schedule: "0 4 * * 1" in vercel.json (06:00 Swedish summer time, Mondays).
//
// Auth: accepts either:
