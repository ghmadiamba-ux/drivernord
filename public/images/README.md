...
| `company-hero.jpg` | `/company` hero (desktop right column) | Transport coordinator or logistics manager in a professional Swedish office or control room. Subject seated or standing at a desktop monitor or tablet showing a planning dashboard/map interface. Logistics yard or warehouse visible through a window is a strong plus. Business casual attire, no exaggerated stock-photo energy. Diverse — person of colour preferred. No DriverNord branding on vehicles. Format: landscape 4:3, min 1600×1200 px. |
